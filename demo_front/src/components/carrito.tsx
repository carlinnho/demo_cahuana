    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Contenedor del Carrito (Fondo Blanco igual que Categorías) */}
          <motion.div
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            {/* Cabecera del Carrito (Fondo Gris F4F6FB) */}
            ...
            {/* Contenido (Lista de productos rediseñada) */}
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div className="pr-6">
                      ...
                      {/* line-clamp-2 recorta el texto a 2 líneas y pone "..." si es muy largo */}
            ...
            <div className="p-6 bg-white border-t border-gray-200 mt-auto shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
              ...
              <button className="w-full bg-[#42BC0D] hover:bg-[#38a00b] text-white font-bold py-3.5 rounded-md text-[15px] transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2">
                Finalizar Compra
              </button>
            </div>
          </motion.div>
