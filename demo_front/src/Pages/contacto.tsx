  ...
  return (
    <div className="font-sans text-[#313131] bg-[#F4F6FB] min-h-screen">
      ...
      <section className="relative w-full h-[300px] flex items-center justify-center">
        {/* Fondo oscuro con imagen de taller/autos */}
        <div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-8 mb-12">
              ...
              <div className="flex gap-5 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#313131]/70 font-medium">998 904 830</p>
                </div>
              </div>
            ...
            <div className="w-full h-[300px] bg-gray-200 rounded-2xl overflow-hidden shadow-sm border border-gray-100">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3901.7610026210087!2d-77.03960162409551!3d-12.059958188177576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c8c6c5188f61%3s0x43d26b8db7c98099!2sCompuPlaza!5e0!3m2!1ses-419!2spe!4v1714580000000!5m2!1ses-419!2spe" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
          ...
          <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] relative">
            ...
            {/* Botón flotante WhatsApp (Opcional decorativo en la tarjeta) */}
            <a href="#" className="absolute -right-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-[#42BC0D] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform hidden md:flex">
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                {/* Contacto Lima */}
                <div className="bg-[#F4F6FB] p-5 rounded-xl border border-gray-100 hover:border-[#42BC0D]/30 transition-colors">
                  <p className="text-xs font-bold text-[#313131]/50 uppercase tracking-wide mb-2">Lima</p>
                  <p className="font-black text-[#313131] text-lg flex items-center gap-2">
              ...
              {/* Contacto Extranjero */}
              <div className="bg-[#F4F6FB] p-5 rounded-xl border border-gray-100 hover:border-[#42BC0D]/30 transition-colors w-full">
